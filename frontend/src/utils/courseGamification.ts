...
export const COURSE_RANK_TIERS: CourseRankTier[] = [
  ...
  },
  {
    ...
    description: 'Trạng thái tập trung sâu, hiểu sâu bản chất kiến thức',
    ...
    tagline: 'Bạch Kim Lam Ngọc - Tập trung cao độ',
  },
  {
    level: 6,
...
export function getMythicPrestigeStage(points: number = 0): MythicPrestigeStage {
  ...
  if (surplusXP < 5000) {
    ...
    return {
      ...
      starsCount: 2,
      starsDisplay: '⭐⭐',
      auraName: 'Dải Cực Quang Huyền Bí',
      auraColor: '#06b6d4',
    ...
    return {
      ...
      starsCount: 4,
      starsDisplay: '⭐⭐⭐⭐',
      auraName: 'Sóng Xung Kích Thần Thánh',
      auraColor: '#eab308',
    ...
    return {
      ...
      starsCount: 5,
      starsDisplay: '⭐⭐⭐⭐⭐ 👑',
      auraName: 'Trường Lực Thần Giới Tối Cao',
      auraColor: '#f59e0b',
